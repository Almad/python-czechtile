...
'''
        ...
        self.assertEquals(tree.children[0].children[1].children[0].children[2].content, u', která bude sloužit k lepšímu plánování - cíle tohoto roku, konkrétní aktivity, průběh tohoto roku')
        ...
        self.assertEquals(tree.children[0].children[1].children[1].children[2].content, u' - nabídka konkrétních činností')
        ...
        self.assertEquals(tree.children[0].children[1].children[3].children[1].content, u' - nabídník nárazové i dlouhodobé věci, vyčlenit novou pro sponzory, konkrétní nabídky, co jim může naše činnost dát')
        ...
        self.assertEquals(tree.children[0].children[3].children[4].children[0].content, u'představení článků - texty od nich, umístit dosavadně vytvořené - redigovat je')
